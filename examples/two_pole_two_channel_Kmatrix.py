...
def create_threshold_kmatrix():
    ...
    # Create channels
    pipi_channel = ds.Channel(particle1=CommonParticles.PI_PLUS, particle2=CommonParticles.PI_MINUS)

    kk_channel = ds.Channel(particle1=CommonParticles.K_PLUS, particle2=CommonParticles.K_MINUS)
