...
class TestChannelAutoWrapping:
    ...
    def test_channel_already_wrapped_particles(self):
        ...
        channel = Channel(particle1=CommonParticles.K_PLUS, particle2=CommonParticles.K_MINUS)
    ...
    def test_channel_attribute_forwarding_after_wrapping(self):
        ...
        channel = Channel(particle1=CommonParticles.PROTON, particle2=CommonParticles.NEUTRON)
