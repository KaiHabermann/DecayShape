...
import pytest
import numpy as np
from decayshape import config, set_backend, RelativisticBreitWigner
...
class TestConfigProperties:
    ...
    def test_backend_function_availability(self):
        ...
        required_functions = [
            'array', 'sum', 'sqrt', 'ones_like', 'zeros_like',
            'real', 'imag', 'abs', 'angle', 'exp', 'log',
            'sin', 'cos', 'pi', 'where', 'isfinite', 'isnan'
        ]
