...
class TestFixedParamIntegration:
    ...
    def test_fixedparam_with_particles(self):
        ...
        channel = Channel(particle1=fp_particle, particle2=CommonParticles.PI_MINUS)
...
class TestRealWorldScenarios:
    ...
    def test_coupled_channel_analysis(self):
        ...
        np.argmin(np.abs(s_values - pipi_threshold))
        np.argmin(np.abs(s_values - kk_threshold))
