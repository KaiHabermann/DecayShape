...
from decayshape.particles import Channel, CommonParticles, Particle
...
class TestChannel:
    ...
    def test_channel_string_representation(self):
        ...
        channel = Channel(particle1=CommonParticles.PI_PLUS, particle2=CommonParticles.K_PLUS)
    ...
    def test_different_particle_combinations(self):
        ...
        pipi_channel = Channel(
            particle1=FixedParam(value=CommonParticles.PI_PLUS), particle2=FixedParam(value=CommonParticles.PI_MINUS)
        )
...
class TestChannelPhysics:
    ...
    def test_momentum_formula(self):
        ...
        channel = Channel(particle1=particle1, particle2=particle2)
